  ...
  <el-dialog title="编辑等级" :visible.sync="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" ref="form">
      ...
      <el-form-item label="升级条件" :label-width="formLabelWidth" v-if="form.is_default==0">
		...
		<div class="d-s-c mt16">
		  <el-checkbox v-model="form.open_yongjin">推荐人佣金满</el-checkbox>
		  <el-input v-model="form.upgrade_yongjin" type="number" :disabled="form.open_yongjin==0" style="width: 160px;margin-left: 10px;"></el-input>
		  <span class="ml10">元</span>
		  
		</div>
		 <div class="gray9">(其它是满足一项，这个是必须满足，不计算这次佣金)</div>
      </el-form-item>
    </el-form>
...
<script>
  ...
  export default {
    ...
    created() {
	  ...
	  this.form.open_yongjin=this.form.open_yongjin==1?true:false;
