<template>
  <div class="product-add" v-loading="loading">
    ...
    <el-form size="small" ref="form" :model="form" label-width="180px" v-if="!loading">
      ...
      <!--团品实拍-->
      <Content1 v-show="activeName == 'content1'"></Content1>
      <!--资质授权-->
      <Content2 v-show="activeName == 'content2'"></Content2>
      <!--关于售后-->
      <Content3 v-show="activeName == 'content3'"></Content3>
...
import Content1 from './part/Content1.vue';
import Content2 from './part/Content2.vue';
import Content3 from './part/Content3.vue';
